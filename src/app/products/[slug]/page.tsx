        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-32 border-t border-white/5 pt-16">
            <div className="flex items-center gap-2 mb-10">
              <span className="material-symbols-outlined text-white text-[18px]">grade</span>
              <h2 className="text-[11px] uppercase tracking-[0.3em] text-white font-bold">Recomendaciones</h2>
            </div>

            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-8">
              {recommendations.map((item) => (
                <Link key={item.id} href={`/products/${item.slug}`} className="group block">
                  <div className="aspect-square relative overflow-hidden bg-neutral-900 border border-white/5 mb-4">
                    <Image 
                  ...
                  <h3 className="text-[9px] uppercase tracking-widest text-white font-bold mb-1 truncate">
                    {item.name}
                  </h3>
            ...
            <div className="mt-10">
              <Link 
                href="/products" 
                className="block w-full border border-white/10 py-4 text-center text-[10px] uppercase tracking-[0.2em] text-neutral-400 hover:text-white hover:border-white/20 transition-all font-bold"
              >
                Ver más opciones
              </Link>
            </div>
